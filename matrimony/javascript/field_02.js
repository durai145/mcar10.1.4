		...
		else 
		{
			...
			{		
					...
					else if(fieldObj.dataType =='HIDDEN')
					{
						...
						fldStr='<input type="hidden"   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >';
						rtString+=fldStr;
