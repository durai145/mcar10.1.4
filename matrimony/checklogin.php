...
$sql="select  g.grp_id GroupId, i.usr_id UserId , grp_name GroupName ,i.Food_type FoodType, email_id   myusername, g.grp_name GroupName from GID001TB i, GRP001TB g where g.grp_id  = i.grp_id and  i.email_id ='$emailid' and i.password ='$password'";
