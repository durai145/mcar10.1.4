	...
	//		autoOpen: true,
		...
		$( "#create-user" )
			...
			.click(function() {
				...
				var div="GroupId";
				var url="grpid.php";
				var json={seqname:"GID001TB.GRP_ID"};
...
<div id="dialog-form" title="Add New User">
	...
	<fieldset>
		<table border=0>
			<tr> 
			<td><label for="name">Group Id</label>
			</td>
			<td>
		<input type="text" name="GroupId" id="GroupId" placeholder="Last Name" class="text ui-widget-content ui-corner-all" />
		</td>
		</tr>
			<tr> 
