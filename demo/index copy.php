...
<meta http-equiv="content-type" content="text/html;charset=UTF-8" />
	...
	<title>Heaerie-Carnatic</title>
		...
		<script language="javascript" src="../javascript/<?php echo $_POST['nameLangName'] ?>/Resource.js"> </script>
		<script>
				var docSource="";
		</script>  
	...
	<script>
	var lang="<?php echo $_POST['nameLangName'] ?>";
...
<audio role="application" id="s" src="../audio/C3.m4a" preload="auto"></audio>
<audio role="application" id="r" src="../audio/C_3.m4a" preload="auto"></audio>
<audio role="application" id="g" src="../audio/D_3.m4a" preload="auto"></audio>
<audio role="application" id="m" src="../audio/F3.m4a" preload="auto"></audio>
<audio role="application" id="p" src="../audio/G3.m4a" preload="auto"></audio>
<audio role="application" id="D" src="../audio/G_3.m4a" preload="auto"></audio>
<audio role="application" id="N" src="../audio/B3.m4a" preload="auto"></audio>
<audio role="application" id="S" src="../audio/C4.m4a" preload="auto"></audio>



<audio role="application" id="s"  src="../audio/C3.m4a" preload="auto"></audio>
<audio role="application" id="r1" src="../audio/C_3.m4a" preload="auto"></audio>
<audio role="application" id="r2"  src="../audio/D3.m4a" preload="auto"></audio>
<audio role="application" id="g1"  src="../audio/D3.m4a" preload="auto"></audio>
<audio role="application" id="r3" src="../audio/D_3.m4a" preload="auto"></audio>
<audio role="application" id="g2" src="../audio/D_3.m4a" preload="auto"></audio>
<audio role="application" id="g3"  src="../audio/E3.m4a" preload="auto"></audio>
<audio role="application" id="m1"  src="../audio/F3.m4a" preload="auto"></audio>
<audio role="application" id="m2" src="../audio/F_3.m4a" preload="auto"></audio>
<audio role="application" id="p"  src="../audio/G3.m4a" preload="auto"></audio>
<audio role="application" id="D1" src="../audio/G_3.m4a" preload="auto"></audio>
<audio role="application" id="D2"  src="../audio/A3.m4a" preload="auto"></audio>
<audio role="application" id="N1"  src="../audio/A3.m4a" preload="auto"></audio>
<audio role="application" id="N2" src="../audio/A_3.m4a" preload="auto"></audio>
<audio role="application" id="D3" src="../audio/A_3.m4a" preload="auto"></audio>
<audio role="application" id="N3"   src="../audio/B3.m4a" preload="auto"></audio>
<audio role="application" id="S"  src="../audio/C4.m4a" preload="auto"></audio>
<audio role="application" id="R1" src="../audio/C_4.m4a" preload="auto"></audio>
<audio role="application" id="R2"  src="../audio/D4.m4a" preload="auto"></audio>
<audio role="application" id="G1"  src="../audio/D4.m4a" preload="auto"></audio>
<audio role="application" id="R3" src="../audio/D_4.m4a" preload="auto"></audio>
<audio role="application" id="G2" src="../audio/D_4.m4a" preload="auto"></audio>
<audio role="application" id="G3"  src="../audio/E4.m4a" preload="auto"></audio>
<audio role="application" id="M1"  src="../audio/F4.m4a" preload="auto"></audio>
<audio role="application" id="M2" src="../audio/F_4.m4a" preload="auto"></audio>
<audio role="application" id="P"  src="../audio/G4.m4a" preload="auto"></audio>
<audio role="application" id="d1" src="../audio/G_2.m4a" preload="auto"></audio>
<audio role="application" id="d2"  src="../audio/A2.m4a" preload="auto"></audio>
<audio role="application" id="n1"  src="../audio/A2.m4a" preload="auto"></audio>
<audio role="application" id="n2" src="../audio/A_2.m4a" preload="auto"></audio>
<audio role="application" id="d3" src="../audio/A_2.m4a" preload="auto"></audio>
<audio role="application" id="n3"   src="../audio/B2.m4a" preload="auto"></audio>
<audio role="application" id="b"  src="../audio/G2.m4a" preload="auto"></audio>

<div class="demo-description">
				<div class="cform">

						<div style="MARGIN: 2px auto; WIDTH: 880px; BACKGROUND: #020302"> <!-- header table !!!-->
								<div>
	...
	<center>	
	<div class="apphead"> 
												<script language="javascript">document.write(NCARMENU001H);</script>	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-2">Tamil Isai</a></li>
		<li><a href="#tabs-3">Tamil Isai Basic Practicies</a></li>
	</ul>
		...
		<div style="" id="tabs-1">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr><td>
					<p class="text3"> <script language="javascript">document.write(NCARHOME001I);</script> </p>
	
					<!--?php include("../search-ragas/index.php"); ?--> </td></tr>
