...
function rtCreateField(fieldObj)
{
	var rtString = "";
	var fldStr="";	
		...
		else 
		{
			...
			{		
					...
					else
					{
						...
						if (fieldObj.dataType != 'DIVROW') 
						{
							//write('<td>');
							fldStr='<td>';
							rtString+=fldStr;
							//write('<label  class="clabel"  for="'+fieldObj.name+'">');
							fldStr='<label  class="clabel"   for="'+fieldObj.group+'_'+fieldObj.name+'">';
							rtString+=fldStr;
						...
						{
							//write('<td colspan=2>');
							fldStr='<td> <div   id="'+fieldObj.group+'_'+fieldObj.name+'LDiv"  > </div> " ';
							fldStr='</td>';
							rtString+=fldStr;
					...
					if (fieldObj.dataType == 'LIST') 
					{
						...
						//write( '<SELECT dataType="'+fieldObj.dataType+'" nameid="'+fieldObj.group+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  xmlname="'+fieldObj.name+'"   id="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"   parent="'+fieldObj.parent+'"   class="ctext"  value="'+fieldObj.dflt+'" mndf="'+fieldObj.mndf+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"     >');
						fldStr='<SELECT dataType="'+fieldObj.dataType+'" name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'" xmlname="'+fieldObj.name+'"    id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'"   parent="'+fieldObj.parent+'"   class="ctext"  value="'+fieldObj.dflt+'" mndf="'+fieldObj.mndf+'"  label=" '+fieldObj.label+'"   onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"    >';
						rtString+=fldStr;
					...
					{
						//write ('<div    name="'+fieldObj.group+'_'+fieldObj.name+'Div"  nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'Div"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" > <img src="../img/loading.gif"></div>');
						fldStr='<div   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'Div"   xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" > DIVTEST </div>';
						rtString+=fldStr;
					
					}	
					else if(fieldObj.dataType =='DIVROW')
					{
						//write ('<div    name="'+fieldObj.group+'_'+fieldObj.name+'Div" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'Div"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" > <img src="../img/loading.gif"></div>');
						fldStr='<div   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.name+'Div"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" > DIVTEST </div>';
						rtString+=fldStr;
					...
					{
						//write ('<textarea    name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >' +fieldObj.dflt +'</textarea>');
						fldStr='<textarea   name="'+fieldObj.group+'_'+fieldObj.name+'"  nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >' +fieldObj.dflt +'</textarea>';
						rtString+=fldStr;
					...
					{
						//write ('<input type="hidden"   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >');
						fldStr='<input type="hidden"   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.name+'" xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >';
						rtString+=fldStr;
					
					}
					else if(fieldObj.dataType =='LABEL')
					{
						//write('<input type="text"   readonly class="label" nameid="'+fieldObj.group+'"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'" id="'+fieldObj.name+'" mndf="'+fieldObj.mndf+'"   desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >');
						fldStr='<input type="text"  readonly class="label" nameid="'+fieldObj.group+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  mndf="'+fieldObj.mndf+'"  desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >';
						rtString+=fldStr;
						if(fieldObj.help=='Y')
						{
			...
			//				<A  id=link   HREF="javascript:onClickLink('');"> <img src="../img/cal.jpg" width="25px" height="25px" />  </a>
						...
						if(fieldObj.desc=='Y')
						{
							...
							fldStr='<input type="text"  readonly class="label" name="'+fieldObj.group+'_'+fieldObj.name+'Desc"     xmlname="'+fieldObj.name+'Desc"  id="'+fieldObj.group+'_'+fieldObj.name+'Desc" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" dataType="LABEL" value=""  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'" >';
							rtString+=fldStr;
						}
					...
					{
						//write('<input type="password"  class="ctext"   nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  name="'+fieldObj.group+'_'+fieldObj.name+'"  mndf="'+fieldObj.mndf+'"  label="'+fieldObj.label+'"   xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >');
						fldStr='<input type="password"  class="ctext"  nameid="'+fieldObj.group+'"   name="'+fieldObj.group+'_'+fieldObj.name+'"   mndf="'+fieldObj.mndf+'"  label="'+fieldObj.label+'"   xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >';
						rtString+=fldStr;
					...
					//	//write('<input  type="hidden" mndf="'+fieldObj.mndf+'"  dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" id="'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> '+ inpStrArr[i+1] );
						//write('<input  type="text" mndf="'+fieldObj.mndf+'"  dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> '  );
						...
						fldStr='<input  type="hidden" mndf="'+fieldObj.mndf+'" nameid="'+fieldObj.group+'" dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> ';
						rtString+=fldStr;
						}
						//write('<input  type="radio"  dataType="'+fieldObj.dataType+'"    xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] );
						fldStr='<input  type="radio" dataType="'+fieldObj.dataType+'"   xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] ;
						rtString+=fldStr;
					...
					{
						//write('<input type="hidden"    name="'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  xmlname="'+fieldObj.name+'"  dataType="'+fieldObj.dataType+'"  container="Y" parent="'+fieldObj.parent+'"  xml="Y" >');
						fldStr='<input type="hidden"    name="'+fieldObj.name+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  xmlname="'+fieldObj.name+'"  dataType="'+fieldObj.dataType+'"  container="Y" parent="'+fieldObj.parent+'"  xml="Y" >';
						rtString+=fldStr;
						
					}
					else
					{
						//write('<input type="text"  class="ctext"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'"  nameid="'+fieldObj.group+'" id="'+fieldObj.name+'" mndf="'+fieldObj.mndf+'"   desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >');
						fldStr='<input type="text"  class="ctext" nameid="'+fieldObj.group+'"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'"  nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  mndf="'+fieldObj.mndf+'"  desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >';
						rtString+=fldStr;
						if(fieldObj.help=='Y')
						{
		...
		else 
		{
			...
			{		
					...
					else
					{
						...
						if (fieldObj.dataType != 'DIVROW') 
						{
							...
							fldStr='<td>';
							rtString+=fldStr;
							write('<label  class="clabel"  for="'+fieldObj.group+'_'+fieldObj.name+'">');
							fldStr='<label class="clabel"  for="'+fieldObj.group+'_'+fieldObj.name+'">';
							rtString+=fldStr;
							write(fieldObj.label);
							fldStr=fieldObj.label;
						...
						else
						{
							...
							fldStr='<td> <div   id="'+fieldObj.group+'_'+fieldObj.name+'LDiv"  > LAbel</div> </td> <td> ';
							write(fldStr);
					...
					{
						write ('<textarea    name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >' +fieldObj.dflt +'</textarea>');
						fldStr='<textarea   name="'+fieldObj.group+'_'+fieldObj.name+'"   id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >' +fieldObj.dflt +'</textarea>';
						rtString+=fldStr;
					...
					{
						write ('<input type="hidden"   name="'+fieldObj.group+'_'+fieldObj.name+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >');
						fldStr='<input type="hidden"   name="'+fieldObj.group+'_'+fieldObj.name+'"   id="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'" xmlname="'+fieldObj.name+'"  parent="'+fieldObj.parent+'"  dataType="'+fieldObj.dataType+'" >';
						rtString+=fldStr;
					...
					{
						write('<input type="text"   readonly class="label" nameid="'+fieldObj.group+'"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'" id="'+fieldObj.name+'" mndf="'+fieldObj.mndf+'"   desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >');
						fldStr='<input type="text"  readonly class="label" nameid="'+fieldObj.group+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'" id="'+fieldObj.name+'" mndf="'+fieldObj.mndf+'"  desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >';
						rtString+=fldStr;
						if(fieldObj.help=='Y')
						{
			...
			//				<A  id=link   HREF="javascript:onClickLink('');"> <img src="../img/cal.jpg" width="25px" height="25px" />  </a>
					...
					//	write('<input  type="hidden" mndf="'+fieldObj.mndf+'"  dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" id="'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> '+ inpStrArr[i+1] );
						write('<input  type="text" mndf="'+fieldObj.mndf+'"  dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> '  );
						//fldStr='<input  type="hidden" mndf="'+fieldObj.mndf+'" dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" id="'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> '+ inpStrArr[i+1];
						fldStr='<input  type="hidden" mndf="'+fieldObj.mndf+'" dataType="'+fieldObj.dataType+'" label="'+fieldObj.label+'" xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'" xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'"  id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"> ';
						rtString+=fldStr;
						}
						write('<input  type="radio"  dataType="'+fieldObj.dataType+'"    xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] );
						fldStr='<input  type="radio" dataType="'+fieldObj.dataType+'"   xmlname="'+fieldObj.name+'" name="'+fieldObj.group+'_'+fieldObj.name+'"  parent="'+fieldObj.parent+'" nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  value="'+inpStrArr[i]+'"  onchange="javascript:'+ fieldObj.onchange+'" > '+ inpStrArr[i+1] ;
					...
					{
						write('<input type="text"  class="ctext"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'"  nameid="'+fieldObj.group+'" id="'+fieldObj.group+'_'+fieldObj.name+'"  mndf="'+fieldObj.mndf+'"   desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >');
						fldStr='<input type="text"  class="ctext"  name="'+fieldObj.group+'_'+fieldObj.name+'" xmlname="'+fieldObj.name+'"  nameid="'+fieldObj.group+'" id="'+fieldObj.name+'" mndf="'+fieldObj.mndf+'"  desc="'+fieldObj.desc+'" dataType="'+fieldObj.dataType+'"  xml="'+fieldObj.xml+'"  parent="'+fieldObj.parent+'" value="'+fieldObj.dflt+'"  label="'+fieldObj.label+'"  onchange="javascript:'+ fieldObj.onchange+'"    onkeydown="javascript:'+ fieldObj.onkeydown +'" onkeypress="javascript:'+ fieldObj.onkeypress+'"  onkeyup="javascript:'+ fieldObj.onkeyup+'"   >';
						rtString+=fldStr;
						if(fieldObj.help=='Y')
						{
...
function createField(field)
{
	...
	with(document)
	{
		...
		{
			write (   '<input type="hidden"   name="'+field.group+'.'+field.name+'"   id="'+fieldObj.group+'_'+fieldObj.name+'"  xml="'+field.xml+'" xmlname="'+field.name+'"  parent="'+field.parent+'"  dataType="'+field.dataType+'" >');
			rtString+='<input type="hidden"   name="'+field.group+'.'+field.name+'"   id="'+fieldObj.group+'_'+fieldObj.name+'"   xml="'+field.xml+'" xmlname="'+field.name+'"  parent="'+field.parent+'"  dataType="'+field.dataType+'" >';
		
		}
		else if(field.dataType =='PASSWORD')
		{
			write(    '<input type="password"  class="ctext"     name="'+field.group+'_'+field.name+'"  mndf="'+field.mndf+'"  label="'+field.label+'"   xml="'+field.xml+'" xmlname="'+field.name+'"  parent="'+field.parent+'"  dataType="'+field.dataType+'" >');
		...
		{
			write(    '<input type="text"  class="ctext"  name="'+field.group+'.'+field.name+'" xmlname="'+field.name+'"  id="'+fieldObj.group+'_'+fieldObj.name+'" mndf="'+field.mndf+'" dataType="'+field.dataType+'"  xml="'+field.xml+'"  parent="'+field.parent+'" value="'+field.dflt+'"  label="'+field.label+'"  onchange="javascript:'+ field.onchange+'"    onkeydown="javascript:'+ field.onkeydown +'" onkeypress="javascript:'+ field.onkeypress+'"  onkeyup="javascript:'+ field.onkeyup+'"   >');
			rtString+='<input type="text"  class="ctext"  name="'+field.group+'.'+field.name+'" xmlname="'+field.name+'" id="'+field.name+'" mndf="'+field.mndf+'" dataType="'+field.dataType+'"  xml="'+field.xml+'"  parent="'+field.parent+'" value="'+field.dflt+'"  label="'+field.label+'"  onchange="javascript:'+ field.onchange+'"    onkeydown="javascript:'+ field.onkeydown +'" onkeypress="javascript:'+ field.onkeypress+'"  onkeyup="javascript:'+ field.onkeyup+'"   >';
			if(field.desc=='Y')
			{
			    write(    '<input type="text"  readonly class="label" name="'+field.group+'.'+field.name+'Desc"     xmlname="'+field.name+'Desc"  id="'+fieldObj.group+'_'+fieldObj.name+'Desc" xml="'+field.xml+'"  parent="'+field.parent+'" dataType="LABEL" value=""  label="'+field.label+'"  onchange="javascript:'+ field.onchange+'" >');
			    rtString+='<input type="text"  readonly class="label" name="'+field.group+'.'+field.name+'Desc"     xmlname="'+field.name+'Desc" id="'+fieldObj.group+'_'+fieldObj.name+'Desc" xml="'+field.xml+'"  parent="'+field.parent+'" dataType="LABEL" value=""  label="'+field.label+'"  onchange="javascript:'+ field.onchange+'" >';
			}
			if(field.help=='Y')
			{
