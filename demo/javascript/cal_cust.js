...
//			alert(ceil(((i%36== 0)?36:(i%36))*1.00/6.0));
		...
		melNoObj.value= parseInt(SObj.val() )+ 
						parseInt(RObj.val() )+ 
						parseInt(GObj.val() )+ 
						parseInt(MObj.val() )+ 
						parseInt(PObj.val() )+ 
...
allGObj = $( [] ).add( 	G1Obj  ).add(G2Obj).add( G3Obj );
...
allMObj = $( [] ).add( 	M1Obj  ).add(M2Obj);
		...
		var R2Obj=$("#" + R2Id) ;
		var R3Obj=$("#" + R3Id) ;
allRObj = $( [] ).add( 	R1Obj  ).add(R2Obj).add( R3Obj );
		...
		var D2Obj=$("#" + D2Id) ;
		var D3Obj=$("#" + D3Id) ;
allDObj = $( [] ).add( 	D1Obj  ).add(D2Obj).add( D3Obj );
		...
		var N2Obj=$("#" + N2Id) ;
		var N3Obj=$("#" + N3Id) ;
allNObj = $( [] ).add( 	N1Obj  ).add(N2Obj).add( N3Obj );
...
allSwaras = $ ([]).add(allRObj) .add(allGObj) .add(allMObj) .add(allPObj) .add(allDObj) .add(allNObj);


allSwaras.removeClass();
allSwaras.show();
			var comb=0;
		var dycm="|";
		...
		if( lvSc ==1 )
		{
			...
			case '1': comb=72;
			  ...
			  N2Obj.val(2); 
					...
					D1Obj.val(0);
					D2Obj.val(parseInt(N2Obj.val())); //4
					D3Obj.val(parseInt(N2Obj.val())+1);    //N2+N3+1-N3 =    6


					
					G1Obj.val(0);
					G2Obj.val(parseInt( D3Obj.val() )  + parseInt( N3Obj.val() )) ; // D3+N3+1-N1 =3+3+1-1
					G3Obj.val( parseInt( G2Obj.val() )+ parseInt( D3Obj.val() )  + parseInt( N3Obj.val() ) ) ; // D3+N3+1-N1 =3+3+1-1

					R1Obj.val(0);
					R2Obj.val( parseInt( G3Obj.val() )+ parseInt( D3Obj.val() )  + parseInt( N3Obj.val() )  -  parseInt( G2Obj.val() ) ) ;
 								//G3+D3+N3-G2

					R3Obj.val( parseInt( R2Obj.val() )+  parseInt( D3Obj.val() ) + parseInt( N3Obj.val() )  ) ;   //R2+G3+D3+N3-G3
...
allNObj.addClass( "ui-state-highlight" );

					D1Obj.val(1);
					D2Obj.val(parseInt(2)); //4
					D3Obj.val(parseInt(3)); //N2+N3+1-N3 =    6


					
					G1Obj.val(0);
					G2Obj.val(parseInt( D3Obj.val() )  + parseInt( N3Obj.val() )) ; // D3+N3+1-D1 =3+3+1-1
					G3Obj.val( parseInt( G2Obj.val() )+ parseInt( D3Obj.val() )  + parseInt( N3Obj.val() ) ) ; // D3+N3+1-D1 =3+3+1-1

					R1Obj.val(0);
					R2Obj.val( parseInt( G3Obj.val() )+ parseInt( D3Obj.val() )  + parseInt( N3Obj.val() )  -  parseInt( G2Obj.val() ) ) ; //G3+D3+N3-G2
...
allSwaras.show();
allDObj.addClass( "ui-state-highlight" );
	    ...
	    N1Obj.val(1); 
			  N2Obj.val(2); 
					...
					D1Obj.val(0);
					D2Obj.val(parseInt(0));    //4
					D3Obj.val(parseInt(0));    //N2+N3+1-N3 =    6
...
allPObj.addClass( "ui-state-highlight" );
...
allSwaras.show();
					...
					allMObj.addClass( "ui-state-highlight" );
					allMObj.val(0);
			...
			break;
			case '5': comb=36;
allGObj.addClass( "ui-state-highlight" );
allSwaras.show();
allGObj.val(0);
...
allRObj.addClass( "ui-state-highlight" );
//allRObj.hide();
...
allDObj.show();allNObj.show();
allPObj.show();allNObj.show();
allMObj.show();allNObj.show();
allGObj.show();allNObj.show();
allRObj.show();allNObj.show();
allPObj.show();allDObj.show();
allMObj.show();allDObj.show();
allGObj.show();allDObj.show();
allRObj.show();allDObj.show();
allMObj.show();allPObj.show();
allGObj.show();allPObj.show();
allRObj.show();allPObj.show();
allGObj.show();allMObj.show();
allRObj.show();allMObj.show();
allRObj.show();allGObj.show();
			...
			//		N3Obj.val(3); 
				...
				//	D3Obj.val(parseInt(N2Obj.val())+1);    //N2+N3+1-N3 =    6
					...
					G1Obj.val(1);
					G2Obj.val(2) ; // D3+N3+1-N1 =3+3+1-1
					G3Obj.val(3 ) ; // D3+N3+1-N1 =3+3+1-1

					R1Obj.val(0);
					R2Obj.val( parseInt(   parseInt( G2Obj.val() ) ) );
 								//G3+D3+N3-G2

					R3Obj.val( parseInt( G2Obj.val() ) +1  ) ;   //R2+G3+D3+N3-G3
...
break;
			case '2':  comb=36 ;//allPObj.hide();allNObj.hide();
...
break;
			case '3':  comb=18 ;//allMObj.hide();allNObj.hide();
...
break;
			case '4':  comb=18 ;//allGObj.hide();allNObj.hide();
allGObj.val( 0 );
allNObj.val( 0 );
	allGObj.addClass( "ui-state-highlight" );
					allNObj.addClass( "ui-state-highlight" );
...
break;
			case '5':  comb=18 ;//allRObj.hide();allNObj.hide();
allRObj.val( 0 );
allNObj.val( 0 );
	allRObj.addClass( "ui-state-highlight" );
					allNObj.addClass( "ui-state-highlight" );
...
break;
			case '6':  comb=36 ;//allPObj.hide();allDObj.hide();
allPObj.val( 0 );
allDObj.val( 0 );
	allPObj.addClass( "ui-state-highlight" );
					allDObj.addClass( "ui-state-highlight" );
...
break;
			case '7':  comb=18 ;//allMObj.hide();allDObj.hide();
allMObj.val( 0 );
allDObj.val( 0 );
...
break;
			case '8':  comb=18 ;//allGObj.hide();allDObj.hide();
allGObj.val( 0 );
allDObj.val( 0 );
	allGObj.addClass( "ui-state-highlight" );
					allDObj.addClass( "ui-state-highlight" );
...
break;
			case '9':  comb=18 ;//allRObj.hide();allDObj.hide();
allRObj.val( 0 );
allDObj.val( 0 );
	allRObj.addClass( "ui-state-highlight" );
					allDObj.addClass( "ui-state-highlight" );
...
break;
			case '10': comb=36 ;//allMObj.hide();allPObj.hide();
allMObj.val( 0 );
allPObj.val( 0 );
	allMObj.addClass( "ui-state-highlight" );
					allPObj.addClass( "ui-state-highlight" );
...
break;
			case '11': comb=36 ;//allGObj.hide();allPObj.hide();
allGObj.val( 0 );
allPObj.val( 0 );
	allGObj.addClass( "ui-state-highlight" );
					allPObj.addClass( "ui-state-highlight" );
...
break;
			case '12': comb=36 ;//allRObj.hide();allPObj.hide();
allRObj.val( 0 );
allPObj.val( 0 );
	allRObj.addClass( "ui-state-highlight" );
					allPObj.addClass( "ui-state-highlight" );
...
break;
			case '13': comb=18 ;//allGObj.hide();allMObj.hide();
allGObj.val( 0 );
allMObj.val( 0 );
	allGObj.addClass( "ui-state-highlight" );
					allMObj.addClass( "ui-state-highlight" );
...
break;
			case '14': comb=18 ;//allRObj.hide();allMObj.hide();
allRObj.val( 0 );
allMObj.val( 0 );
	allRObj.addClass( "ui-state-highlight" );
					allMObj.addClass( "ui-state-highlight" );
...
break;
			case '15': comb=12 ;//allRObj.hide();allGObj.hide();
allRObj.val( 0 );
allGObj.val( 0 );
	allRObj.addClass( "ui-state-highlight" );
					allGObj.addClass( "ui-state-highlight" );
